    ...
    <style>
        ...
        * {
        ...
        .hero {
            ...
            padding: 60px 5%;
            background:
                radial-gradient(circle at 85% 20%, rgba(255,200,120,0.14) 0%, transparent 25%),
                linear-gradient(135deg,
                    #fffaf2 0%,
                    #fff2e0 55%,
                    rgba(245, 220, 190, 0.08) 100%);
            overflow: hidden;
        }

        .hero::before {
            /* large blurred golden orb */
            content: '';
            position: absolute;
            top: -6%;
            right: 4%;
            ...
            height: 520px;
            border-radius: 50%;
            background: radial-gradient(circle at 30% 30%, rgba(255,215,140,0.95), rgba(223,124,4,0.65) 40%, rgba(223,124,4,0.18) 60%, transparent 70%);
        ...
        .hero::after {
            ...
            position: absolute;
            inset: 0;
            background: radial-gradient(circle at 10% 90%, rgba(0,0,0,0.06), transparent 30%);
            pointer-events: none;
            z-index: 0;
        }
        ...
        .hero h1 {
            ...
            margin: 20px 0;
            line-height: 1.12;
            text-shadow: 0 6px 30px rgba(138,77,0,0.08);
        ...
        .premium-badge {
            ...
            font-weight: 700;
            font-size: 0.9rem;
            box-shadow: 0 12px 40px rgba(223, 124, 4, 0.22);
        ...
        .btn-cta {
            ...
            border-radius: 50px;
            box-shadow: 0 18px 40px rgba(223, 124, 4, 0.18);
        ...
        .btn-cta:hover {
            ...
            box-shadow: 0 26px 64px rgba(223, 124, 4, 0.28);
            border-color: rgba(138,77,0,0.08);
        }
        ...
        .bottle img {
            ...
            filter: drop-shadow(0 60px 90px rgba(138,77,0,0.18));
            border-radius: 18px;
            transition: transform 0.6s ease;
        }

        .bottle img:hover { transform: rotate(-3deg) scale(1.06); }
        ...
        .hero-decor {
            ...
            height: 420px;
            border-radius: 50%;
            background: radial-gradient(circle at 30% 30%, rgba(255,245,230,0.95), rgba(255,235,200,0.55) 35%, rgba(255,235,200,0.06) 60%, transparent 70%);
            filter: blur(8px) saturate(1.06);
            transform: rotate(-8deg);
            z-index: 1;
            pointer-events: none;
            box-shadow: 0 40px 120px rgba(223,124,4,0.08);
        }
        ...
        .price-badge {
            display: inline-block;
            background: linear-gradient(90deg,#ffe9d6,#fff4ee);
            color: #8a4d00;
            padding: 8px 12px;
            border-radius: 999px;
            font-weight: 800;
            box-shadow: 0 6px 18px rgba(218,145,78,0.08);
            border: 1px solid rgba(138,77,0,0.06);
            margin-top: 6px;
        }
        ...
        .btn-buy {
            ...
            font-weight: 800;
            font-size: 1rem;
            border: 1px solid rgba(138,77,0,0.08);
            box-shadow: 0 8px 24px rgba(223,124,4,0.12);
    ...
    <section class="hero" aria-label="Hero banner">
        <div class="container" style="display: flex; align-items: center; justify-content: space-between; width: 100%;">
            ...
            <div class="bottle" aria-hidden="true">
                <img src="{{ asset('images/caneta.png') }}" alt="Caneta premium" style="max-height:520px;">
            </div>
        </div>
    </section>
        ...
        <div class="products" role="list">
            <article class="card" role="listitem" data-category="executive">
                ...
                <div style="text-align:center;width:100%">
                        ...
                        <div class="price-badge">€ 24.90</div>
                </div>
                <div class="actions">
            ...
            <article class="card" role="listitem" data-category="gift">
                ...
                <div style="text-align:center;width:100%">
                    ...
                    <div class="price-badge">€ 59.00</div>
                </div>
                <div class="actions">
                    <a href="{{ route('products') }}" class="btn-buy">
                        <i class="fas fa-cart-plus"></i>
            ...
            <article class="card" role="listitem" data-category="premium">
                ...
                <div style="text-align:center;width:100%">
                    ...
                    <div class="price-badge">€ 129.00</div>
                </div>
                <div class="actions">
                    <a href="{{ route('products') }}" class="btn-buy">
                        <i class="fas fa-cart-plus"></i>
