...
@section('content')
    ...
    <div class="course-banner"
        ...
        <div class="course-banner-content">
            <h1>Cibersegurança (CTeSP)</h1>
            <p>Formação especializada na proteção e defesa de sistemas, redes e infraestruturas informáticas contra ameaças
                cibernéticas</p>
        </div>
    </div>
            ...
            <div class="course-details">
                <div class="course-info">
                    ...
                    <div class="course-info-card">
                        ...
                        <ul>
                            <li>Identificar e mitigar riscos de segurança informática</li>
                            <li>Implementar políticas e ferramentas de segurança</li>
                            <li>Auditar sistemas e responder a incidentes</li>
                            <li>Proteger redes, dados e aplicações</li>
                            <li>Desenvolver boas práticas de ciber-higiene</li>
                            <li>Monitorizar sistemas e detectar vulnerabilidades</li>
                            <li>Gerir resposta a incidentes e continuidade operacional</li>
                        </ul>
                    </div>
                </div>
                <div class="course-description">
                    <p>O CTeSP em Cibersegurança forma técnicos superiores profissionais capacitados para proteger sistemas,
                        redes e infraestruturas informáticas, aplicando técnicas de análise de riscos, deteção de ameaças,
                        implementação de políticas de segurança e resposta a incidentes cibernéticos.</p>

                    <h3>Objetivos do Curso</h3>
                    <p>Capacitar os alunos para:</p>
                    <ul>
                        <li>Identificar e mitigar riscos de segurança informática</li>
                        <li>Implementar políticas e ferramentas de proteção</li>
                        <li>Auditar sistemas e responder a incidentes de segurança</li>
                        <li>Proteger redes, dados e infraestruturas digitais</li>
                        <li>Aplicar técnicas de criptografia e autenticação</li>
                        <li>Gerir continuidade e recuperação de serviços</li>
                    </ul>
                    <h3>Diferenciais</h3>
                    <ul>
                        <li>Formação prática em ambientes simulados e reais</li>
                        <li>Estágio em empresas e entidades de segurança</li>
                        <li>Projetos desenvolvidos com profissionais da área</li>
                        <li>Parcerias com organizações de cibersegurança</li>
                    </ul>
                </div>
            </div>
        </div>
