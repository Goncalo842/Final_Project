...
@section('content')
    ...
    <div class="course-banner"
        style="background-image: url('https://cruzeirodosul.vtexassets.com/arquivos/ids/162358-800-auto?v=638814430313930000&width=800&height=auto&aspect=true');">
        <div class="course-banner-content">
            <h1>Robotica e Inteligencia Artificial (CTeSP)</h1>
            <p>Formação focada no desenvolvimento, programação e implementação de sistemas robóticos e soluções de
            ...
            <div class="course-details">
                <div class="course-info">
                    ...
                    <div class="course-info-card">
                        ...
                        <ul>
                            <li>Desenvolver e programar sistemas robóticos</li>
                            <li>Integrar sensores e atuadores em sistemas inteligentes</li>
                            <li>Conceber algoritmos de aprendizagem automática</li>
                            <li>Implementar soluções de inteligência artificial</li>
                            <li>Testar e otimizar sistemas autónomos</li>
                            <li>Realizar manutenção e atualização de robôs</li>
                            <li>Colaborar em equipas multidisciplinares de desenvolvimento</li>
                        </ul>
                    </div>
                </div>
                <div class="course-description">
                    <p>O CTeSP em Robótica e Inteligência Artificial forma técnicos superiores profissionais com
                        competências em desenvolvimento, programação e integração de sistemas robóticos e inteligentes,
                        incluindo sensores, atuadores e algoritmos de aprendizagem automática.</p>

                    <h3>Objetivos do Curso</h3>
                    <p>Capacitar os alunos para:</p>
                    <ul>
                        <li>Desenvolver sistemas robóticos e inteligentes</li>
                        <li>Programar algoritmos de inteligência artificial</li>
                        <li>Integrar sensores e atuadores em projetos reais</li>
                        <li>Aplicar aprendizagem automática em diferentes domínios</li>
                        <li>Implementar sistemas autónomos e de controlo</li>
                        <li>Trabalhar com plataformas e linguagens específicas da área</li>
                    </ul>
                    <h3>Diferenciais</h3>
                    <ul>
                        <li>Laboratórios equipados para robótica e IA</li>
                        <li>Projetos práticos e desafios tecnológicos</li>
                        <li>Estágio em empresas inovadoras do setor</li>
                        <li>Orientação por especialistas em robótica e IA</li>
                    </ul>
                </div>
            </div>
        </div>
