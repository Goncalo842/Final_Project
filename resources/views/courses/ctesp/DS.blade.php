...
@section('content')
    ...
    <div class="course-banner"
        style="background-image: url('https://images.unsplash.com/photo-1610563166150-b34df4f3bcd6?auto=format&fit=crop&w=1350&q=80');">
        <div class="course-banner-content">
            <h1>Desenvolvimento de Software (CTeSP)</h1>
            <p>Formação profissional para conceção, desenvolvimento e otimização de software e sistemas de informação</p>
        </div>
    </div>
            ...
            <div class="course-details">
                <div class="course-info">
                    ...
                    <div class="course-info-card">
                        ...
                        <ul>
                            <li>Projetar software e sistemas de informação</li>
                            <li>Interpretar requisitos e conceber soluções técnicas</li>
                            <li>Gerir metodologias e ferramentas de desenvolvimento</li>
                            <li>Implementar e colocar sistemas em funcionamento</li>
                            <li>Conceber arquiteturas e documentar soluções</li>
                            <li>Controlar qualidade, manutenção, versionamento e otimização</li>
                            <li>Supervisionar equipas e processos de software</li>
                        </ul>
                    </div>
                </div>
                <div class="course-description">
                    <p>O CTeSP em Desenvolvimento de Software forma técnicos superiores profissionais com competências
                    ...
                    <ul>
                        <li>Interpretar requisitos e projetar soluções de software</li>
                        <li>Implementar sistemas com metodologias modernas de desenvolvimento</li>
                        <li>Gerir bases de dados SQL e NoSQL</li>
                        <li>Desenvolver aplicações web, móveis e back‑end</li>
                        <li>Assegurar a qualidade: testes e cibersegurança básica</li>
                        <li>Elaborar documentação técnica e atuar em ambiente profissional</li>
                    </ul>
                    <h3>Diferenciais</h3>
                    <ul>
                        <li>Alta componente prática nos primeiros 3 semestres</li>
                        <li>Estágio no 4.º semestre em empresas (FCT)</li>
                        <li>Estrutura projetual com forte componente de trabalho real</li>
                        <li>Acompanhamento por profissional com experiência (coordenador)</li>
                    </ul>
                </div>
            </div>
        </div>
