...
@section('content')
    ...
    <div class="course-banner" style="background-image: url('https://images.unsplash.com/photo-1486312338219-ce68d2c6f44d');">
        <div class="course-banner-content">
            <h1>Redes e Sistemas (CTeSP)</h1>
            <p>Formação técnica em implementação, manutenção e segurança de redes e sistemas informáticos</p>
        </div>
    </div>
            ...
            <div class="course-details">
                <div class="course-info">
                    ...
                    <div class="course-info-card">
                        ...
                        <ul>
                            <li>Configurar e administrar redes informáticas</li>
                            <li>Garantir segurança e monitorização de sistemas</li>
                            <li>Instalar e manter hardware e software de rede</li>
                            <li>Resolver problemas técnicos e prestar suporte</li>
                            <li>Gerir servidores, serviços e infraestrutura</li>
                            <li>Implementar políticas de backup e recuperação</li>
                            <li>Planejar e executar atualizações e migrações</li>
                        </ul>
                    </div>
                </div>
                <div class="course-description">
                    <p>O CTeSP em Redes e Sistemas forma técnicos superiores profissionais com competências em configuração,
                        administração e segurança de redes informáticas, gestão de servidores, monitorização de sistemas e
                        suporte técnico para garantir o funcionamento eficiente da infraestrutura tecnológica.</p>
                    ...
                    <ul>
                        <li>Configurar e administrar redes informáticas</li>
                        <li>Garantir segurança e monitorização de sistemas</li>
                        <li>Gerir servidores e infraestrutura tecnológica</li>
                        <li>Diagnosticar e resolver problemas técnicos</li>
                        <li>Implementar políticas de continuidade e backup</li>
                        <li>Suportar utilizadores e operações diárias</li>
                    </ul>
                    <h3>Diferenciais</h3>
                    <ul>
                        <li>Laboratórios equipados para redes e sistemas</li>
                        <li>Formação prática com casos reais</li>
                        <li>Estágio em empresas e centros tecnológicos</li>
                        <li>Supervisão por técnicos especializados</li>
                    </ul>
                </div>
            </div>
        </div>
