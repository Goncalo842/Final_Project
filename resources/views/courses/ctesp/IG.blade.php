...
@section('content')
    ...
    <div class="course-banner"
        style="background-image: url('https://images.unsplash.com/photo-1517148815978-75f6acaaf32c?auto=format&fit=crop&w=1350&q=80');">
        <div class="course-banner-content">
            <h1>Informação de Gestão (CTeSP)</h1>
            <p>Formação na gestão de sistemas de informação e suporte tecnológico para processos empresariais</p>
        </div>
    </div>
            ...
            <div class="course-details">
                <div class="course-info">
                    ...
                    <div class="course-info-card">
                        ...
                        <ul>
                            <li>Gerir sistemas de informação empresariais</li>
                            <li>Suportar processos organizacionais com tecnologia</li>
                            <li>Administrar bases de dados e aplicações de gestão</li>
                            <li>Implementar soluções ERP e CRM</li>
                            <li>Analisar requisitos e melhorar processos internos</li>
                            <li>Garantir segurança e integridade dos dados</li>
                            <li>Formar utilizadores e prestar suporte técnico</li>
                        </ul>
                    </div>
                </div>
                <div class="course-description">
                    <p>O CTeSP em Informática de Gestão forma técnicos superiores profissionais preparados para gerir
                        sistemas de informação empresariais, suportar processos organizacionais, administrar bases de dados
                        e implementar soluções tecnológicas alinhadas com os objetivos das organizações.</p>

                    <h3>Objetivos do Curso</h3>
                    <p>Capacitar os alunos para:</p>
                    <ul>
                        <li>Administrar sistemas de informação empresarial</li>
                        <li>Gerir bases de dados e processos organizacionais</li>
                        <li>Implementar soluções tecnológicas para negócios</li>
                        <li>Suportar a tomada de decisão com informação precisa</li>
                        <li>Desenvolver competências em análise e planeamento</li>
                        <li>Garantir segurança e integridade dos dados</li>
                    </ul>
                    <h3>Diferenciais</h3>
                    <ul>
                        <li>Integração de teoria e prática em contexto empresarial</li>
                        <li>Estágio em organizações e empresas diversas</li>
                        <li>Projetos orientados para necessidades reais</li>
                        <li>Orientação por profissionais experientes</li>
                    </ul>
                </div>
            </div>
        </div>
